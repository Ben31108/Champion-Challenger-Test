...
Caveat: I wrote the original program using the Sublime editor, and have executed it from that editor and from Jupyter Notebooks. In its present form it will not work in GitHub or Google Colab. To run it the user will require an environment that supports Tkinter.
